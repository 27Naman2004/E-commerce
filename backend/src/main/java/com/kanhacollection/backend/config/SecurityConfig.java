...
import com.kanhacollection.backend.auth.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/products/**", "/categories/**", "/reviews/**").permitAll()
                        // Public Webhooks & Documentation
                        .requestMatchers("/webhooks/**", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/actuator/**").permitAll()
